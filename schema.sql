...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `progress_monitor_suggestions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `progress_monitor_suggestions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `activity_instance_id` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_pms_instance` FOREIGN KEY (`activity_instance_id`) REFERENCES `activity_instances` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_pms_audit` FOREIGN KEY (`audit_log_id`) REFERENCES `audit_log` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=458194 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1195394 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
