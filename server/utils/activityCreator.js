...
async function generateWithOpenAI({
  ...
  const system = [
    ...
    'For the embedded Skulpt turtle runtime, prefer portable basics only: forward, backward, left, right, penup, pendown, goto, circle, color, begin_fill, end_fill, hideturtle, done, and turtle.Screen(). Avoid module-level calls like turtle.bgcolor(); if you want a background color, use screen = turtle.Screen(); screen.bgcolor(...), or omit the background entirely.',
